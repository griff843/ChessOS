...
test.describe("Progress", () => {
  test("dashboard progress surfaces update after a completed session", async ({
    api,
    page,
  }) => {
    ...
    await expect(page.getByText("Theme Trends")).toBeVisible();
    await expect(page.getByText("Improvement Report")).toBeVisible();
